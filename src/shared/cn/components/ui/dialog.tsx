    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          className,
          mobileMode &&
            "w-full h-full max-h-screen max-w-full bg-background/85 dark:bg-background/50 pt-12 backdrop-blur-md dark:backdrop-blur-xl overflow-y-auto rounded-none flex flex-col gap-6 border-0"
        )}
        {...props}
      >
        {children}
